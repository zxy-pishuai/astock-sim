@echo off
rem Phase57: forward-eval daily task (idempotent). Pure ASCII: codepage-proof.
...
set BFLAG=%~dp0..\tmp\batch_running\forward_eval.flag
if not exist "%~dp0..\tmp\batch_running" mkdir "%~dp0..\tmp\batch_running"
echo started >"%BFLAG%"
"C:\Users\26838\AppData\Local\Programs\Python\Python313\python.exe" tools\forward_eval.py >>data\forward_eval_cron.log 2>&1
del "%BFLAG%" 2>nul
